...
public partial class Admin_GovermentDoc : System.Web.UI.Page
{
    SqlCommand com;
    string str;
    SqlCommand cmd;
    ...
    private void BindRoleRptr()
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("select * from NgoRegisterTable Where NgoType='Goverment Ngo' order By Id asc", con))
            {
