...
public partial class Admin_User : System.Web.UI.Page
{
    ...
    private Boolean InsertUpdateData(SqlCommand cmd)
    {
        ...
        try
        {
            con.Open();
            cmd.ExecuteNonQuery();
            SqlCommand cmd1 = new SqlCommand("insert into LoginTable (EmailId,Password,UserType,Status,Name) Values ('" + txtEmail.Text + "','" + txtPassword.Text + "','U','Active','"+ txtFullName.Text +"')", con);
