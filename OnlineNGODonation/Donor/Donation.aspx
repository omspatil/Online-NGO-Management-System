    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-body -->
           <!--  original <div class="card-footer">
                ...
                <div class="card-footer">
                    <asp:Button ID="btnSubmitDonation" runat="server" Text="Submit" CssClass="btn btn-primary float-right" OnClick="btnSubmit_Click" CausesValidation="true" />

                    <a href="https://donate.stripe.com/test_dR614YdHb6jneNWeUU" class="btn btn-success float-right" style="margin-right: 10px;">DONATE NOW</a>
                </div>
