<%@ Page Title="" Language="C#" MasterPageFile="~/Donor/DonorMasterPage.master" AutoEventWireup="true" CodeFile="Event.aspx.cs" Inherits="Donor_Event" %>
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="exampleInputAddress">Donor Name</label>
                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="txtEvent" Display="Dynamic"></asp:RequiredFieldValidator>
                        ...
                        <div class="col-md-6">
                              <div class="form-group">
                                <label for="txtAddress">Event</label>
                                <asp:TextBox ID="txtEvent" runat="server" placeholder="Describe about event" CssClass="form-control" TextMode="MultiLine" Rows="8"></asp:TextBox>
                            </div>
                        </div>
                        <!-- /.col -->
                    </div>
