...
public partial class VolunteerRegisterPage : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        using (SqlConnection con = new SqlConnection(CS))
        {
            string strQuery = "insert into VolunteerRegisterTable(NGOName, FirstName, LastName,MobileNumber , Address , State,City,Pincode,Skillsets,DaysOfWork,Commets,Status) values (@NGOName, @FirstName, @LastName,@MobileNumber , @Address , @State,@City,@Pincode,@Skillsets,@DaysOfWork,@Commets,'Pending')";
